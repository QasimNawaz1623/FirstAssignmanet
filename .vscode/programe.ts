...
var a = ('\nQ 28');
    ...
    let age = 3;
let stagesOfLife = [2, 4, 13, 20, 65];

for (let i = 0; i < stagesOfLife.length; i++) {
...
(Favourite_fruits.includes(Favourite_fruits[1])){
  console.log(`${Favourite_fruits}}) is in the array`)
} else if 
(Favourite_fruits.includes(Favourite_fruits[2])){
  console.log(`${Favourite_fruits}) is in the array`)
}else 
{
  console.log(`${Favourite_fruits}) is in the array`)
...
//part 2
let favourite_fruits = ['mango','banana','strawberry'];
...
//part 2
let labours = ["Arslan","Ahmed","Usama","ALi"];
...
console.log(a);
//part 1
let animals_name = ["Dog","cat","Horse","rabbit"];
...
function make_shirts (size  , message ="I love javascript"){
  console.log("The size is "+ size + " and the message is: "+ message);
}
make_shirts("L");
make_shirts("M");
...
let magician = ["Lance Burton","Ricky Jay","Mark Wilson"];
