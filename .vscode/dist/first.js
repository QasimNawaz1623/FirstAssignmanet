...
console.log(famous_person + Message); //Question 6 (Six)
var myName = 'Q 6';
console.log(myName);
var person_Name = "\tRaja Qasim Nawaz\n \tJam Muhammad Ahmed Lar\n \tUsama khan\n";
var hello = person_Name;
console.log(hello); //Question 7 (seven)
var myName = 'Q 7';
console.log(myName);
var n1 = 4;
var n2 = 4;
...
console.log("________________________________________");
console.log(5 + 3);
console.log("________________________________________"); //Question 9 (Nine)
var myName = 'Q 9';
console.log(myName);
var z = 9;
console.log("\nMy favourite number is " + z); //Question 10 (Ten)
var myName = '\nQ 10';
...
var z = 9;
console.log("My favourite number is " + z); //Question 11 (Eleven)
var myName = '\nQ 11';
console.log(myName);
var alphas;
...
console.log(alphas[4]); //Question 12 (twelve)
var myName = 'Q 12';
console.log(myName);
var alphas;
alphas = ["Ali", "Ahmed", "Arslan", "Usama", "Qasim"];
